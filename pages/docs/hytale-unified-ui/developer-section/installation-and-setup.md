...
- Dependency must be imported as compileOnly. If using as an implementation dependency then your plugin will never talk to the instance that Hytale Server loads.
